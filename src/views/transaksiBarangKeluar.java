...
public class transaksiBarangKeluar extends javax.swing.JDialog {
    ...
    public void dataTable(){
        Object[] Baris = {"No","Tanggal","ID Detail BK","ID BK","Gudang","Kode Barang","Nama Barang","Jumlah","Keterangan"};
        ...
        try{
            ...
            while (hasil.next()){
                ...
                String[] data = {"",tanggal,id_detail_bk,id_bk,gudang,kode_brg,nama_brg,jumlah,keterangan};
                tabmode.addRow(data);
                noTable();
            }
        } catch (Exception e){
    ...
    private void initComponents() {
        ...
        labelNama.setText("Transaksi Barang Keluar PT.Rajawali Nusindo");
        ...
        panelHeaderLayout.setHorizontalGroup(
            ...
            .addGroup(panelHeaderLayout.createSequentialGroup()
                .addGap(276, 276, 276)
                .addComponent(labelNama, javax.swing.GroupLayout.PREFERRED_SIZE, 508, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        labelGudang.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(labelKodeBrg, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            ...
                            .addComponent(labelGudang, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                            .addComponent(labelNamabrg, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        .addComponent(btnCari, javax.swing.GroupLayout.Alignment.LEADING, javax.swing.GroupLayout.DEFAULT_SIZE, 134, Short.MAX_VALUE)
                        .addComponent(txtIdDetailBarangKeluar, javax.swing.GroupLayout.Alignment.LEADING)))
                    ...
                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.TRAILING, false)
                        ...
                        .addGroup(jPanel1Layout.createSequentialGroup()
                            .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addComponent(btnCetak, javax.swing.GroupLayout.PREFERRED_SIZE, 97, javax.swing.GroupLayout.PREFERRED_SIZE))
                            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                    ...
                                    .addComponent(btnBersih, javax.swing.GroupLayout.DEFAULT_SIZE, 37, Short.MAX_VALUE))))
                        .addGap(46, 46, 46)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        String sql = "update tb_detail_brg_keluar set tanggal=?,id_detail_bk=?,id_bk=?,gudang=?,kode_brg=?,nama_brg=?,jumlah=?,keterangan=? where id_detail_bk='"+txtIdDetailBarangKeluar.getText()+"'";
        String tampilan = "dd-MM-yyyy";
        SimpleDateFormat fm = new SimpleDateFormat(tampilan);
        String tanggal = String.valueOf(fm.format(btnPilihTanggal.getDate()));
        try {
    ...
    private void txtCariBarangKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariBarangKeyTyped
        String sqlPencarian2 = "select * from tb_barang where kode_brg like '%"+txtCariBarang.getText()+"%' or nama_brg like '%"+txtCariBarang.getText()+"%'";
