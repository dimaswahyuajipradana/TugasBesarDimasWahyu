...
public class dataGudang extends javax.swing.JDialog {
    ...
    private void aktif(){
        txtkdgudang.setEnabled(true);
        txtnmgudang.setEnabled(true);
        txtalamat.setEnabled(true);
        txtketerangan.setEnabled(true);
    }
    
    protected void kosong(){
        txtkdgudang.setText(null);
        txtnmgudang.setText(null);
    ...
    private void initComponents() {
        ...
        txtkdgudang = new javax.swing.JTextField();
        btnPilihTanggal = new com.toedter.calendar.JDateChooser();
        txtnmgudang = new javax.swing.JTextField();
        ...
        labelNama.setFont(new java.awt.Font("Times New Roman", 1, 18)); // NOI18N
        labelNama.setText("Data Gudang PT.Rajawali Nusindo");
        ...
        panelHeaderLayout.setHorizontalGroup(
            ...
            .addGroup(panelHeaderLayout.createSequentialGroup()
                .addGap(194, 194, 194)
                .addComponent(labelNama, javax.swing.GroupLayout.PREFERRED_SIZE, 319, javax.swing.GroupLayout.PREFERRED_SIZE)
        ...
        labelKodeGudang.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        labelNamaGudang.setFont(new java.awt.Font("Times New Roman", 1, 14)); // NOI18N
        ...
        txtkdgudang.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtkdgudang.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtkdgudangKeyPressed(evt);
            }
        });
        ...
        txtnmgudang.setFont(new java.awt.Font("Tahoma", 0, 14)); // NOI18N
        txtnmgudang.addKeyListener(new java.awt.event.KeyAdapter() {
            public void keyPressed(java.awt.event.KeyEvent evt) {
                txtnmgudangKeyPressed(evt);
            }
        });
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                            ...
                            .addComponent(txtkdgudang)
                            .addComponent(txtnmgudang)
                            ...
                            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                ...
                                .addGroup(jPanel1Layout.createSequentialGroup()
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        ...
                                        .addComponent(txtkdgudang, javax.swing.GroupLayout.DEFAULT_SIZE, 30, Short.MAX_VALUE))
                                    .addGap(5, 5, 5)
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                        .addGroup(jPanel1Layout.createSequentialGroup()
                                            .addComponent(txtnmgudang, javax.swing.GroupLayout.PREFERRED_SIZE, 30, javax.swing.GroupLayout.PREFERRED_SIZE)
                                            .addGap(5, 5, 5)
    ...
    private void tabelGudangMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_tabelGudangMouseClicked
        ...
        txtkdgudang.setText(c);
        txtnmgudang.setText(d);
        txtalamat.setText(e);
    ...
    private void btnSimpanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSimpanActionPerformed
        ...
        try {
            ...
            stat.setString(2, txtkdgudang.getText());
            stat.setString(3, txtnmgudang.getText());
    ...
    private void btnUbahActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnUbahActionPerformed
        String sql = "update tb_gudang set tanggal=?,kode_gudang=?,nama_gudang=?,alamat=?,keterangan=? where kode_gudang='"+txtkdgudang.getText()+"'";
        String tampilan = "dd-MM-yyyy";
        SimpleDateFormat fm = new SimpleDateFormat(tampilan);
        String tanggal = String.valueOf(fm.format(btnPilihTanggal.getDate()));
        try {
    ...
    private void btnHapusActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnHapusActionPerformed
        ...
        if (ok==0){
            String sql="delete from tb_gudang where kode_gudang='"+txtkdgudang.getText()+"'";
            try {
                PreparedStatement stat=conn.prepareStatement(sql);
                stat.executeUpdate();
    ...
    private void txtkdgudangKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtkdgudangKeyPressed
        if(evt.getKeyCode()== KeyEvent.VK_ENTER){
            txtnmgudang.requestFocus();
        }
    }//GEN-LAST:event_txtkdgudangKeyPressed

    private void txtnmgudangKeyPressed(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtnmgudangKeyPressed
        if(evt.getKeyCode()== KeyEvent.VK_ENTER){
            txtalamat.requestFocus();
        }
    }//GEN-LAST:event_txtnmgudangKeyPressed
    ...
    private javax.swing.JTextField txtkdgudang;
    private javax.swing.JTextArea txtketerangan;
    private javax.swing.JTextField txtnmgudang;
