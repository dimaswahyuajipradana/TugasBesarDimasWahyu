...
public class laporanBarangKeluar extends javax.swing.JDialog {
    ...
    public void dataTable(){
        Object[] Baris = {"No","Tanggal","ID BK","Gudang","Kode Barang","Nama Barang","Jumlah","Keterangan"};
    ...
    public void pencarian(String sql){
        ...
        try{
            ...
            while (hasil.next()){
                ...
                String[] data = {"",tanggal,id_bk,gudang,kode_brg,nama_brg,jumlah,keterangan};
                tabmode.addRow(data);
                noTable();
            }
        } catch(Exception e){
    ...
    private void initComponents() {
        ...
        labelNama.setText("Laporan Barang Keluar PT.Rajawali Nusindo");
        ...
        panelHeaderLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, panelHeaderLayout.createSequentialGroup()
                ...
                .addComponent(labelNama, javax.swing.GroupLayout.PREFERRED_SIZE, 534, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(300, 300, 300))
        );
    ...
    private void txtCariKeyTyped(java.awt.event.KeyEvent evt) {//GEN-FIRST:event_txtCariKeyTyped
        String sqlPencarian = "select * from tb_detail_brg_keluar where id_bk like '%"+txtCari.getText()+"%' or nama_brg like '%"+txtCari.getText()+"%'";
    ...
    private void btnCetakActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCetakActionPerformed
        try {
            ...
            File file = new File("src/report/laporanbrgkeluar.jrxml");
            String tampilan = "dd-MM-yyyy";
            SimpleDateFormat fm = new SimpleDateFormat(tampilan);
            String tanggalAwal = String.valueOf(fm.format(tglAwal.getDate()));
            String tanggalAkhir = String.valueOf(fm.format(tglAkhir.getDate()));
